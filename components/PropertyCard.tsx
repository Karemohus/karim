...
import { MapPinIcon, BanknotesIcon, ArrowsPointingOutIcon, BedIcon, ShowerIcon, SparklesIcon } from './icons';
...
const PropertyCard: React.FC<PropertyCardProps> = ({ property, onSelect, aiReason }) => {
  return (
    <div 
      className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5"
    >
